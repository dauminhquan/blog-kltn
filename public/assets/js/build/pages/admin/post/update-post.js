...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__content_vue__ = __webpack_require__(259);
...
var app = new Vue({
    components: {
        'content-wrapper': __WEBPACK_IMPORTED_MODULE_0__content_vue___default.a
    },
    el: '#page-content'
});
...
Component.options.__file = "resources\\assets\\js\\admin\\post\\postsmanage\\updatepost\\content.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0befeaaa", Component.options)
  } else {
    hotAPI.reload("data-v-0befeaaa", Component.options)
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_select2_vue__ = __webpack_require__(261);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getSkills: function getSkills() {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].get(vm.configUrl.API_JOB_GET_LIST_SKILL).then(function (data) {
                vm.skills = data.data;
                if (vm.skills.length > 0) {
                    vm.skills = vm.skills.map(function (item) {
                        return {
                            id: item.id,
        ...
        getPositions: function getPositions() {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].get(vm.configUrl.API_JOB_GET_LIST_POSITION).then(function (data) {
                vm.positions = data.data;
                if (vm.positions.length > 0) {
                    vm.positions = vm.positions.map(function (item) {
                        return {
                            id: item.id,
        ...
        getTypes: function getTypes() {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].get(vm.configUrl.API_JOB_GET_LIST_TYPE_JOB).then(function (data) {
                vm.types = data.data;
                if (vm.types.length > 0) {
                    vm.types = vm.types.map(function (item) {
                        return {
                            id: item.id,
        ...
        acceptPost: function acceptPost() {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].put(vm.configUrl.API_ADMIN_JOB_MANAGE_ACCEPT_POST(vm.idPost)).then(function (data) {
                vm.accepted = 1;
        ...
        updatePost: function updatePost() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].post(vm.configUrl.API_ENTERPRISE_POST + '/' + vm.idPost, formData).then(function (data) {
                new PNotify({
                    title: 'Ohh Yeah! Thành công!',
        ...
        acceptdeletePost: function acceptdeletePost() {
            var vm = this;
            vm.deleting = true;
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].delete(vm.configUrl.API_ENTERPRISE_POST + '/' + vm.idPost).then(function (data) {
        ...
        getPost: function getPost() {
            ...
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].get(vm.configUrl.API_ADMIN_JOB_MANAGE_GET_DETAIL_POST(vm.idPost)).then(function (data) {
                _this.city = data.data.cities.map(function (item) {
                    return item.city;
                });
                _this.list_positions = data.data.positions.map(function (item) {
                    return item.pivot.id_position.toString();
                });
                _this.list_skills = data.data.skills.map(function (item) {
                    return item.pivot.id_skill.toString();
                });
                _this.list_types = data.data.types.map(function (item) {
                    return item.pivot.id_job_type.toString();
                });
                _this.description_post = data.data.info.description_post;
                _this.content_post = data.data.info.content_post;
                _this.location = data.data.info.localtion;
                _this.title_post = data.data.info.title_post;
                _this.time_start_post = data.data.info.time_start_post;
                _this.time_end_post = data.data.info.time_end_post;
                _this.accepted = data.data.info.accept;
            }).catch(function (err) {});
        },
...
Component.options.__file = "resources\\assets\\js\\admin\\post\\postsmanage\\updatepost\\components\\select2.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2e75de62", Component.options)
  } else {
    hotAPI.reload("data-v-2e75de62", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    watch: {
        value: function value(_value) {
            if (this.cn == 0) {
                console.log(_value);
                $(this.select).val(_value).trigger('change');
            }
        },
...
var render = function() {
  ...
  return _c(
    ...
    [_vm.noneSelect ? _c("option") : _vm._e()]
  )
}
var staticRenderFns = []
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2e75de62", module.exports)
  }
}
          ...
          [
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.title_post,
                          expression: "title_post"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text", required: "" },
                      domProps: { value: _vm.title_post },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.title_post = $event.target.value
                        }
                      }
                    })
                  ])
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c("select2", {
                        ...
                        model: {
                          value: _vm.list_positions,
                          callback: function($$v) {
                            _vm.list_positions = $$v
                          },
                          expression: "list_positions"
                        }
                      })
                    ],
                    1
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c("select2", {
                        ...
                        model: {
                          value: _vm.list_skills,
                          callback: function($$v) {
                            _vm.list_skills = $$v
                          },
                          expression: "list_skills"
                        }
                      })
                    ],
                    1
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c("select2", {
                        ...
                        model: {
                          value: _vm.list_types,
                          callback: function($$v) {
                            _vm.list_types = $$v
                          },
                          expression: "list_types"
                        }
                      })
                    ],
                    1
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.time_start_post,
                          expression: "time_start_post"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "date", required: "" },
                      domProps: { value: _vm.time_start_post },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.time_start_post = $event.target.value
                        }
                      }
                    })
                  ])
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.time_end_post,
                          expression: "time_end_post"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "date", required: "" },
                      domProps: { value: _vm.time_end_post },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.content_post,
                      expression: "content_post"
                    }
                  ],
                  staticClass: "form-control",
                  attrs: { id: "content-post", required: "" },
                  domProps: { value: _vm.content_post },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.content_post = $event.target.value
                    }
                  }
                })
              ])
            ...
            _c("div", { staticClass: "text-right" }, [
              _vm.uploading == true
                ...
                : _vm._e(),
              _vm._v(" "),
              _vm.accepted == 0 && _vm.updateAccept == false
                ? _c(
                    "button",
                    {
                      staticClass: "btn btn-success",
                      attrs: { type: "button" },
                      on: { click: _vm.acceptPost }
                    },
                    [
                      _vm._v("Chấp nhận bài viết "),
                      _c("i", { staticClass: "icon-check2 position-right" })
                    ]
                  )
                : _vm._e(),
              _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0befeaaa", module.exports)
  }
}
