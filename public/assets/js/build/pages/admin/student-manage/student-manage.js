...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        demodelete: function demodelete() {
            // console.log($(item).parents('tr'))
            this.table.row($().parents('tr')).remove().draw();
        }
    },
    data: function data() {
        return {
            ...
            _c(
              ...
              [
                _c("th-check-all", {
                  ...
                  on: { setcheckAll: _vm.setCheckAllData }
                })
              ],
              1
            ),
        ...
        _c("tbody", [
          _c("tr", [
            _c(
              ...
              [
                _c("td-checkbox", {
                  attrs: { checkAll: _vm.checkAll, "id-item": "1" },
                  on: {
                    push_item_selected: function($event) {
                      _vm.id_item_selected.push($event)
                    },
          ...
          _c("tr", [
            _c(
              ...
              [
                _c("td-checkbox", {
                  attrs: { checkAll: _vm.checkAll, "id-item": "2" },
                  on: {
                    push_item_selected: function($event) {
                      _vm.id_item_selected.push($event)
                    },
          ...
          _c("tr", [
            _c(
              ...
              [
                _c("td-checkbox", {
                  attrs: { checkAll: _vm.checkAll, "id-item": "3" },
                  on: {
                    push_item_selected: function($event) {
                      _vm.id_item_selected.push($event)
                    },
          ...
          _c("tr", [
            _c(
              ...
              [
                _c("td-checkbox", {
                  attrs: { checkAll: _vm.checkAll, "id-item": "4" },
                  on: {
                    push_item_selected: function($event) {
                      _vm.id_item_selected.push($event)
                    },
