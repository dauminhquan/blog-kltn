...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            getAvatarUser(){
                var vm = this
                axios.get(vm.configUrl.API_ENTERPRISE_OPTION_PROFILE+ '?email_address_enterprise='+vm.email_address_enterprise+'&option[]=avatar_enterprise&option[]=name_enterprise').then(data => {
