    ...
    export default {
        ...
        methods: {
            ...
            confirm_delete(){
                var vm = this
                vm.deleting = true
                axios.delete(vm.configUrl.API_ADMIN_JOB_MANAGE_DELETE_LIST_SKILL,
                    {
                        params: {
            ...
            getSkills(){
                var vm = this
                axios.get(vm.configUrl.API_ADMIN_JOB_MANAGE_GET_LIST_SKILL).then(data => {
            ...
            confirm_delete_item(id){
                var vm = this
                vm.deleting = true
                axios.delete(vm.configUrl.API_ADMIN_JOB_MANAGE_DELETE_SKILL,
                    {
                        params: {
                            id : id
                        }
            ...
            submitPushSkill(){
                ...
                axios.post(vm.configUrl.API_ADMIN_JOB_MANAGE_ADD_SKILL,{
            ...
            submitEditSkill(){
                ...
                if(vm.item_skill_edit.id == '')
                {
                    ...
                    axios.put(vm.configUrl.API_ADMIN_JOB_MANAGE_EDIT_SKILL,vm.item_skill_edit).then(data => {
                        new PNotify({
                            title: 'Ohh Yeah! Thành công!',
                            text: data.data.message,
                            addclass: 'bg-success'
