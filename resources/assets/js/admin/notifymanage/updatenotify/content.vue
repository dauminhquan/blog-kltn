    ...
    <div class="content-wrapper">
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">Update thông báo</h5>
            ...
            <div class="panel-body">
                ...
                <form v-on:submit.prevent="updateNotify">
                    ...
                    <div class="text-right">
                       ...
                       <button type="button" @click="deleteNotify" class="btn btn-danger">Xóa thông báo <i class="icon-trash-alt position-right"></i></button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger" @click="acceptdeleteNotify">Xác định xóa</button>
    ...
    export default {
        ...
        methods:{
            ...
            updateNotify(){
                ...
                axios.post(vm.configUrl.API_ADMIN_NOTIFY_MANAGE_UPDATE_NOTIFY(vm.idNotify),formData).then(data => {
                    new PNotify({
            ...
            acceptdeleteNotify(){
                var vm = this
                vm.deleting = true
                axios.delete(vm.configUrl.API_ADMIN_NOTIFY_MANAGE_DELETE_NOTIFY(vm.idNotify)).then(data => {
            ...
            getNotify(){
                ...
                axios.get(vm.configUrl.API_ADMIN_NOTIFY_MANAGE_GET_NOTIFY(vm.idNotify)).then(data => {

                    this.description_notify = data.data.description_notify
                    this.content_notify = data.data.content_notify

                    this.title_notify = data.data.title_notify
